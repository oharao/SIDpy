...
def test_create_plot(create_tmpdir, header, png_path):
    ...
    image_path = vlfclient.create_plot(header, df, file_path=str(file_path),
...
def test_create_plot_xrs(create_tmpdir, header, png_path):
    ...
    image_path = vlfclient.create_plot_xrs(header, df, file_path=str(file_path),
                                           archive_path=str(create_tmpdir), gl=gl, gs=gs, original_sid=True)
    assert image_path == png_path
